...
export const siteSettingsDefinition: SingletonDefinition = {
  ...
  seed: () => ({
    ...
    favicon: null,
    defaultTitle: 'Destiny — Connection Rave',
    defaultDescription: 'Perth’s next high-energy rave experience.',
    ogImage: { src: '/assets/event-poster.jpg', alt: 'DESTINY poster', mediaId: null },
    defaultEventId: 'evt_destiny',
