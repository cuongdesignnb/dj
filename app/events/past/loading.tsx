...
/**
 * Skeleton mirroring the /events/past layout so nothing jumps when content lands.
 */
    ...
    >
      ...
      <Container>
        ...
        <div className="grid grid-cols-1 gap-8 py-10 lg:grid-cols-2">
          <div className="aspect-[4/5] rounded-[18px] bg-white/[0.04]" />
          <div className="flex flex-col gap-4">
            <div className="h-4 w-32 rounded-full bg-rave-red/25" />
            <div className="h-14 w-3/4 rounded-md bg-white/[0.06]" />
            <div className="h-4 w-full rounded-md bg-white/[0.04]" />
        ...
        <div className="grid grid-cols-1 gap-6 py-10 md:grid-cols-2">
          {[0, 1, 2, 3].map((i) => (
            <div key={i} className="h-56 rounded-[18px] bg-white/[0.03]" />
          ))}
        </div>
      </Container>
    </main>
